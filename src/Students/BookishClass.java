...
/**
 * Class of all bookish students.
 */
class BookishClass extends StudentsThatKeepVisitedClass implements  //package private.
        Bookish,KeepsVisitedOnlyLeisure {
    ...
    /**
     * Constructor of the BookishClass.
     ...
     */
    public BookishClass(String type, String name, String country, Service home) {
